...
const Sidebar = ({ show }: IProps) => {
  ...
  return (
    <div
      ...
      } flex flex-col flex-wrap max-w-1/4 max-sm:flex-row max:sm:w-full xl:rounded-r transform ease-in-out transition duration-700  justify-start items-start h-full bg-gray-900 `}
    >
      ...
      <div className='flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  '>
        ...
        >
          ...
          <svg
            id='icon1'
            className={`${menu[0] ? '' : 'rotate-180'} transform duration-100`}
            width={24}
            height={24}
            viewBox='0 0 24 24'
            fill='none'
      ...
      <div className='flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 '>
        ...
        >
          ...
          <svg
            id='icon3'
            className={`${menu[2] ? '' : 'rotate-180 '} transform duration-100`}
            width={24}
            height={24}
            viewBox='0 0 24 24'
            fill='none'
